      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active"><a href="staffeditpassengertypediscountrate.php"><i class="fa fa-link"></i> <span>Edit Passenger Type<br/>Discount Rate</span></a></li>
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Passenger Type Discount Rate</h3>									
                </div><!-- /.box-header -->
                <div class="box-body">
					...
					<?php
							if(isset($_GET['feedback'])){
								if($_GET['feedback']==1){?>
									<h4>Updated PassengerTypeDiscountRate</h4>	
						<?php     }
							} 
                  ...
                  <form role="form" action="processeditpassengerdiscountrate.php" method="get">
					...
					<?php
					$q="select * from passengertype";
					$result=$mysqli->query($q);
					$row=$result->fetch_array();
					?>
					<?=$row['PassengerTypeName']?> : <input type="text" name="Adult" value="<?=$row['DiscountRate']?>"><br>
					<?php $row=$result->fetch_array(); ?>
					<?=$row['PassengerTypeName']?> : <input type="text" name="Youth" value="<?=$row['DiscountRate']?>"><br>
					<?php $row=$result->fetch_array(); ?>
					<?=$row['PassengerTypeName']?> : <input type="text" name="Disabled" value="<?=$row['DiscountRate']?>"><br>
                    </div>
