        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">View Trip History Record</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				
				<h2>
				<a href="staffviewguesttriphistory.php">View Guest Passenger Trip History Record</a><br>
				<br><a href="staffviewmembertriphistory.php">View Member Passenger Trip History Record</a>
				</h2>
