        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                ...
                <div class="box-body">
					...
					<form action="staffeditstationstep3.php" method="get">
					...
					<select class="form-control" name="interchangablewithstationtypeid">
						<option value="NO"
						<?php
							if($InterchangeWithStationTypeID==NULL){
								echo "selected='selected'";
							}
						?>
						>Not interchangeable</option>
						<?php
					$qstationtype = "select * from stationtype where StationTypeID<>$stationtype";
					$resultstationtype = $mysqli->query($qstationtype);
					while($rowstationtype = $resultstationtype->fetch_array()){
					?>
						...
						<?php
							if($InterchangeWithStationTypeID==$rowstationtype['StationTypeID']){
								echo "selected='selected'";
							}
						?>
