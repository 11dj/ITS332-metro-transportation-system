        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Route and Schedule (step 1)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action="staffaddrouteandschedulestep2.php" method="get">
                    ...
                    <div class="form-group">
                      <label>Select Station type</label>
					...
					<label>Number of route step : </label>
					<input type="text" class="form-control" name="totalstep"><br>
					<label>Number of route starting times : </label>
					<input type="text" class="form-control" name="totalstartingtime"><br>
					<label>Route name :</label>
					<input type="text" class="form-control" name="routename"><br>
                    </div>
