    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Member Passenger > Edit Member Passenger
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
				...
				<h4>
				<b>PassengerID : </b><?=$row['PassengerID']?><br>
				<b>PassengerTypeID : </b><?=$row['PassengerTypeID']?><br>
				<b>PassengerTypeID 1 is Adult, 2 is Youth, 3 is Disabled.</b><br>
				<b>PassengerCitizenORPassportID : </b><?=$row['PassengerCitizenORPassportID']?><br>
				<b>PassengerFirstName : </b><?=$row['PassengerFirstName']?><br>
				<b>PassengerLastName : </b><?=$row['PassengerLastName']?><br>
				<b>PassengerBirthday : </b><?=$row['PassengerBirthday']?><br>
				<b>PassengerEmail : </b><?=$row['PassengerEmail']?><br>
				<b>PassengerCardID : </b><?=$row['PassengerCardID']?><br>
				<b>PassengerBalance :</b> <?=$row['PassengerBalance']?><br>
				</h4>

				<form action="staffeditmemberpassengerprocess.php">
				<input type="hidden" name="PassengerID" value="<?=$row['PassengerID']?>">
				<br><br>
				
				<h3>Edit<h3>

				<h4>
				<b>PassengerType is disable?</b>
				<select name="isdisable">
					<option value="no">No</option>
					<option value="yes"
					<?php
						if($row['PassengerTypeID']==3){
							echo "selected='selected'";
						}
					?>
					>Yes</option>
				</select><br>
				<b>PassengerFirstName : </b><input type="text" name="PassengerFirstName" value="<?=$row['PassengerFirstName']?>"><br>
				<b>PassengerLastName : </b><input type="text" name="PassengerLastName" value="<?=$row['PassengerLastName']?>"><br>
				<b>PassengerEmail : </b><input type="text" name="PassengerEmail" value="<?=$row['PassengerEmail']?>"><br>
				<input type="submit" value="Edit">
				</form><br/><br/>
				<b>In case passenger lost smartcard -></b> <a href="staffrecreatesmartcard.php?PassengerID=<?=$PassengerID?>">Recreate smartcard</a><br/>
				<form action="staffaddmoney.php" method="get">
				<input type="hidden" name="PassengerID" value="<?=$row['PassengerID']?>">
				<b><br/>Add money :</b> <input type="text" name="addmoney">
				<input type="submit" value="Add money!"></h4>
				</form>
