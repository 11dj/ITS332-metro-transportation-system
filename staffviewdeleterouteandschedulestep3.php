    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Station > View/Edit/Delete Station 
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">View/Edit/Delete Station </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				<label>
                  StationTypeID/InterchangeableWithStationTypeID = 1 is BTS<br>
					StationTypeID/InterchangeableWithStationTypeID = 2 is MRT<br>
               </label>
			   <?php
					if(isset($_GET['routeid']) & isset($_GET['scheduleid'])){
				...
				<?php
					if($scheduleid=="all"){
						$q="select * from route as r where RouteID='$routeid' order by RouteID asc, ScheduleID asc, Step asc ";
					}
					else{
						$q="select * from route as r where RouteID='$routeid' and ScheduleID='$scheduleid' order by RouteID asc, ScheduleID asc, Step asc ";
					}
				?>
				<table id="example1" class="table table-bordered table-striped">
					...
					$qso="select StationNameEN from station where StationID='$OStationID' ";
					$qsd="select StationNameEN from station where StationID='$DStationID' ";
					$resultqso=$mysqli->query($qso);
					$resultqsd=$mysqli->query($qsd);
					$rowqso=$resultqso->fetch_array();
					$rowqsd=$resultqsd->fetch_array();
					?>
					<tr>
						<td><?=$row['RouteID']?></td>
						<td><?=$row['ScheduleID']?></td>
						<td><?=$row['Step']?></td>
						<td><?=$OStationID?> : <?=$rowqso['StationNameEN']?> </td>
						<td><?=$DStationID?> : <?=$rowqsd['StationNameEN']?> </td>
						<td><?=$row['Cost']?></td>
					...
					<form action="staffdeleterouteandscheduleprocess.php" method="get">
