		  ...
		  <div class="box box-warning">
			   ...
			   <table id="example1" class="table table-bordered table-striped">
					<tr>
						...
						<th>StationTypeID</th>
						<th>StationName</th>
						<th>InterchangeWithStationTypeID</th>
						<th>InterchangeWithStationID</th>
						<th>Edit Name</th>
						<th>Delete</th>
					</tr>
					<?php
						$_POST['numstation'] = $numstation;
						$numstation = 0;
						...
						<tr>
						<td><?=$row['StationID']?></td>
						<td><?=$row['StationTypeID']?></td>
						<td><?=$row['StationNameEN']?></td>
						<td><?=$row['InterchangeWithStationTypeID']?></td>
						<td><?=$row['InterchangeWithStationID']?></td>
						<td><a href="staffeditstation.php?stationid=<?=$row['StationID']?>&stationtypeid=<?=$row['StationTypeID']?>&stationnameen=<?=$row['StationNameEN']?>&InterchangeWithStationTypeID=<?=$row['InterchangeWithStationTypeID']?>&InterchangeWithStationID=<?=$row['InterchangeWithStationID']?>">Edit</a></td>
						<td><a href="staffdeletestationprocess.php?stationid=<?=$row['StationID']?>">Delete</a></td>
						</tr>
					<?php   
								$numstation = $numstation + 1 ;} ?>
				</table>
			   
			   Total : <?php echo $numstation ?> stations
			   
				 <?php echo $result->fetch_array(); ?> 
