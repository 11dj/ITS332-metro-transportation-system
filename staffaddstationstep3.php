        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Add station (final step)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <div class="form-group">
					  ...
					  <form role="form" action="staffaddstationprocess.php" method="get">
					  


					<input type="hidden" name="stationtype" value="<?=$stationtype?>">
					<input type="hidden" name="stationnameen" value="<?=$stationnameen?>">
					<input type="hidden" name="interchangablewithstationtypeid" value="<?=$interchangablewithstationtypeid?>">
					<?php
						if($interchangablewithstationtypeid=="NO")
							{
							echo "<label>You are good to go, click the button to finalize station creation.<br></label>";
							} 
						else
						{ ?>
					<label>Please select station that you want to interchange with this station</label><br>
					<select class="form-control" name="InterchangeWithStationID">
					 <?php
					$qstationtype = "select * from station where StationTypeID=$interchangablewithstationtypeid";
					$resultstationtype = $mysqli->query($qstationtype);
					while($rowstationtype = $resultstationtype->fetch_array()){
					?>
						<option value="<?=$rowstationtype['StationID']?>"><?=$rowstationtype['StationNameEN']?></option>
					<?php } ?>
					</select>
						<?php } ?>
                    </div>
					...
					<a href="staffaddstation.php"><button type="button" class="btn btn-primary">Back</button></a>
					</div>
