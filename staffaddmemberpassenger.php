      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                ...
                <div class="box-body">
                  <form class="form-horizontal" action="processaddmemberpassenger.php" method="get">
					<label>PassengerID will be automatically assigned<br>
					<!-- Passenger ID:
					<input type="text" name="passengerID"><br> -->
					Is Passenger Disabled : </label>
					<select class="form-control" name="IsDisabled">
						<option value="no">No</option>
						<option value="yes">Yes</option>
					</select><br>
					<label>Passenger CitizenORPassportID :</label> <input type="text" class="form-control" name="passengercitizenorpassportid"><br>
					<label>Passenger Firstname :</label> <input type="text" class="form-control" name="passengerfirstname"><br>
					<label>Passenger Lastname : </label><input type="text" class="form-control" name="passengerlastname"><br>
					<label>Passenger Birthday (format MM/DD/YYYY in AD) ex 12/25/1980:</label> <input type="text" name="passengerbirthday"><br>
					<label>Passenger Email : </label><input type="text" class="form-control" name="passengeremail"><br>
					<label>PassengerCardID will be automatically assigned<br>
					PassengerCardAuthen, which is password inside card used to authenticate at gate and vending machine, will we automatically assigned<br>
					PassengerBalance (in case passenger add money immediately after creating member) </label><input type="text" class="form-control" name="passengerbalance"><br>
					<!-- PassengerWebServicePassword will be assigned later by member passenger himself<br> -->
                    </div>
