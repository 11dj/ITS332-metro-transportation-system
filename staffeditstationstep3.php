        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                ...
                <div class="box-body">
					...
					<form action="staffeditstationprocess.php" method="get">
					...
					<select class="form-control" name="interchangablestationid">
					 <?php
					...
					?>
						<option value="<?=$rowstationtype['StationID']?>"
						<?php
							if($InterchangeWithStationID==$rowstationtype['StationID']){
								echo "selected='selected'";
							}
						?>
						><?=$rowstationtype['StationNameEN']?></option>
					<?php } ?>
					</select>
						<?php } ?>
