    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <?php
					if(isset($_GET['stationtype']) & isset($_GET['stationnameen'])){
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Station (Step 2)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <div class="form-group">
					  ...
					  You have selected StationType as
						<?php
						$qstationtype = "select * from stationtype where StationTypeID=$stationtype";
						$resultstationtype = $mysqli->query($qstationtype);
						while($rowstationtype = $resultstationtype->fetch_array()){
							echo $rowstationtype['StationTypeName'];
						}
						?>
						<br>Please select if you want to make this station interchangeable with other kind of station.
					  ...
					  <form role="form" action="staffaddstationstep3.php" method="get">
					  

						<input type="hidden" name="stationtype" value="<?=$stationtype?>">
						<input type="hidden" name="stationnameen" value="<?=$stationnameen?>">
						<select class="form-control" name="interchangablewithstationtypeid">
							<option value="NO">Not interchangeable</option>
							<?php
						$qstationtype = "select * from stationtype where StationTypeID<>$stationtype";
						$resultstationtype = $mysqli->query($qstationtype);
						while($rowstationtype = $resultstationtype->fetch_array()){
						?>
							<option value="<?=$rowstationtype['StationTypeID']?>"><?=$rowstationtype['StationTypeName']?></option>
						<?php } ?>
						</select>
                    </div>
					...
					<button onclick="window.location.href='staffaddstation.php' " class="btn btn-primary">Back</button>
					</div>
