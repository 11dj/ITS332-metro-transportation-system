        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Add Station (Step 1)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form role="form" action="staffaddstationstep2.php" method="get">
                    ...
                    <div class="form-group">
                      <label>Enter Station name ( English only )</label>
                      <input type="text" class="form-control" name="stationnameen" placeholder="Station name">
                    </div>
