        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title">Re-create ID member</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				  ...
				  <?php
						...
						while($rowcheckCardID['PassengerCardID']!=NULL){
							$CardID = substr(str_shuffle("01234567890123456789"), 0, 16);
							$checkcardIDquery="select PassengerCardID from passenger where PassengerCardID='$PassengerCardID'";
							$resultcheckcardID = $mysqli->query($checkcardIDquery);
							$rowcheckCardID = $resultcheckCardID->fetch_array();
						}
						$CardAuthen = substr(str_shuffle("0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 16);
						$update="update passenger set PassengerCardID='$CardID', PassengerCardAuthen='$CardAuthen' where PassengerID='$PassengerID'";
					...
					<form action="staffeditmemberpassenger.php?PassengerID=<?=$PassengerID?>&feedback=3">
