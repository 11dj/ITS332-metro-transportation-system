    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            View trip history record > Member
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
			   ...
			   <?php
				...
				?>
				<form action="staffviewmembertriphistory.php" method="get">
				Order by : <select name="orderby">
				<?php 
				$q="show columns from triprecordregistereduser";
				$result=$mysqli->query($q);
				while($row=$result->fetch_array())
				{?>
				<?=$row[0]?>
				...
				<table class="table table-bordered table-striped">
					...
					<?php
						$q="select * from triprecordregistereduser $where $orderby";
						$result=$mysqli->query($q);
						while($row=$result->fetch_array()){
						$RouteID=$row['RouteID'];
