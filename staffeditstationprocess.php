      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="staffmainmenu.php"><i class="fa fa-link"></i> <span>Dashboard</span></a></li>
        ...
        <section class="content">
		  ...
		  <div class="box box-warning">
                <div class="box-header with-border">
				  ...
				  <?php
					if(isset($_GET['stationid']) & isset($_GET['stationnameen']) & isset($_GET['interchangablewithstationtypeid']) ){
						$stationtypeid=$_GET['stationtype'];
						$stationid=$_GET['stationid'];
						$stationnameen=$_GET['stationnameen'];
						if($_GET['interchangablewithstationtypeid']=="NO"){
							$update="update station set StationTypeID='$stationtypeid', StationNameEN='$stationnameen', InterchangeWithStationTypeID=NULL, InterchangeWithStationID=NULL where StationID='$stationid'";
						}
						else{
							$interchangablewithstationtypeid=$_GET['interchangablewithstationtypeid'];
							$interchangablestationid=$_GET['interchangablestationid'];
							$update="update station set StationTypeID='$stationtypeid', StationNameEN='$stationnameen', InterchangeWithStationTypeID='$interchangablewithstationtypeid', InterchangeWithStationID='$interchangablestationid' where StationID='$stationid'";
						}
					}
					else{
				...
				<form action="staffvieweditdeletestationbtsormrt.php" method="get">
                    <div class="box-footer">
                    <button type="submit" class="btn btn-primary">View/Edit Station</button>
					</div>
